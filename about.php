...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Hakkımızda</h1>
            <div class="custom-breadcrumbs">
              <a href="#">Ana Sayfa</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Hakkımızda</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="hakkimizda"> 
      <h2><center>Hakkımızda</center></h2>
      <blockquote>
        <p class="metin">Mentorluk platformumuz, bireylerin kariyer hedeflerine ulaşmalarını desteklemek, doğru bilgiye erişimlerini kolaylaştırmak ve uzman mentorlarla buluşmalarını sağlamak amacıyla hayata geçirilmiştir. Yenilikçi teknolojilerle desteklenmiş yapımız, kullanıcılarımıza kişiselleştirilmiş rehberlik sunarak bireysel potansiyellerini keşfetmelerine yardımcı olur.
        Amacımız, kariyer planlamadan kişisel gelişime kadar geniş bir yelpazede rehberlik hizmeti sağlayarak kullanıcılarımızın hayatlarında fark yaratmaktır. Anketler, eğitim modülleri ve uzman görüşmeleri gibi araçlarla bireylerin ihtiyaçlarını analiz ediyor, onlara en uygun meslek ve beceri geliştirme önerilerini sunuyoruz.
        Biz, her bireyin güçlü bir rehberlikle hedeflerine ulaşabileceğine ve hayallerini gerçeğe dönüştürebileceğine inanıyoruz. Kurumumuz, güvenilirlik, inovasyon ve insan odaklı yaklaşımıyla kullanıcılarımız için eşsiz bir deneyim yaratmayı hedefler. Bu yolculukta yanınızda olmaktan mutluluk duyuyoruz.
      </p>
    </blockquote>
    </section>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">Ekibimiz</h2>
          </div>
        </div>
