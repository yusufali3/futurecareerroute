        ...
        <div class="row">
            ...
            <div class="pt-5">
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="#" class="">
                  ...
                  <div class="form-group">
                    <input type="submit" value="Yorum Gönder" class="btn btn-primary btn-md">
                  </div>
          ...
          <div class="col-lg-4 sidebar pl-lg-5">
            ...
            <div class="sidebar-box">
              ...
              <!-- <p><a href="#" class="btn btn-primary btn-sm">Devamını oku</a></p> -->
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            <h3>Destek</h3>
            <ul class="list-unstyled">
              <li><a href="contact.phps">Destek</a></li>
